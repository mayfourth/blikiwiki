...
public class BigPDFTest extends FilterTestSupport {
  ...
  "-fs-flow-right: right; \n" + 
	...
	public BigPDFTest(String name) {
		super(name);
	}

	public static Test suite() {
		return new TestSuite(BigPDFTest.class);
	}

	public void testPDF() {
    // WikiModel myWikiModel = new WikiTestModel("images/${image}", "file:///c:/temp/${title}");
		PDFWikiModel myWikiModel = new PDFWikiModel("images/${image}", "file:///c:/temp/${title}");
		String renderedXHTML = myWikiModel.render(TEST1);
		 System.out.println(renderedXHTML);
		File baseDirectory = new File("c:\\temp");
		try {
