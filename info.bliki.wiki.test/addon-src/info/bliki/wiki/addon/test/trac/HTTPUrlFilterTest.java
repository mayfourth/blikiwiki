...
public class HTTPUrlFilterTest extends TracTestSupport {
	...
	public void testImageUrl() {
		assertEquals(
				"\n"
						+ "<p>see <span class=\"image\"><img alt=\"http://www.plog4u.de/image.gif\" rel=\"nofollow\" src=\"http://www.plog4u.de/image.gif\" /></span></p>",
	...
	public void testMailto() {
		assertEquals("\n" + 
				...
				"<a class=\"external free\" href=\"mailto:someone@domain.com\" rel=\"nofollow\" title=\"mailto:someone@domain.com\">someone</a></p>", wikiModel.render("Linking to an e-mail address works the same way: \n" + 
