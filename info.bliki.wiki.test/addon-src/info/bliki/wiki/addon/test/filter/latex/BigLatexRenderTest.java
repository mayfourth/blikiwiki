...
public class BigLatexRenderTest extends LaTeXTestSupport {
	...
	public BigLatexRenderTest(String name) {
		super(name);
	}

	public static Test suite() {
		return new TestSuite(BigLatexRenderTest.class);
	}

	public void test0() {
		System.out.println(wikiModel.renderLaTeX(TEST1));
		wikiModel.renderLaTeX(TEST1);
	}
}
